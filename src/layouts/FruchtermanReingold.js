...
function FruchtermanReingold (props) {
  ...
  return (
    <div className='layoutSettings settings'>
      ...
      <div>
        <input
          step={0.1} min={0.1} max={20} defaultValue={area.current} onChange={(event) => {
      ...
      <div>
        <input
          step={0.1} min={0.1} max={50} defaultValue={gravity.current} onChange={(event) => {
      ...
      <div>
        <input
          step={0.1} min={0.1} max={50} defaultValue={speed.current} onChange={(event) => {
      ...
      <div>
        <input
          step={1} min={1} max={10000} defaultValue={iterations.current} onChange={(event) => {
